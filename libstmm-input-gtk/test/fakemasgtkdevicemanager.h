...
{
public:
	static shared_ptr<FakeMasGtkDeviceManager> create(bool bEnableEventClasses, const std::vector<Event::Class>& aEnDisableEventClass
												...
												, const Glib::RefPtr<Gdk::DeviceManager>& refGdkDeviceManager)
	{
		shared_ptr<FakeMasGtkDeviceManager> refInstance(
				new FakeMasGtkDeviceManager(bEnableEventClasses, aEnDisableEventClass
											, eKeyRepeatMode
...
//std::cout << "FakeMasGtkDeviceManager::create 1" << '\n';
	...
	FakeMasGtkDeviceManager(bool bEnableEventClasses, const std::vector<Event::Class>& aEnDisableEventClass
						, KEY_REPEAT_MODE eKeyRepeatMode, const shared_ptr<GdkKeyConverter>& refGdkConverter)
	: MasGtkDeviceManager(bEnableEventClasses, aEnDisableEventClass, eKeyRepeatMode, refGdkConverter)
	, m_p0Factory(nullptr)
	, m_p0Backend(nullptr)
	{
