...
{
public:
	static shared_ptr<FakeFloGtkDeviceManager> create(bool bEnableEventClasses, const std::vector<Event::Class>& aEnDisableEventClass
												...
												, const Glib::RefPtr<Gdk::Display>& refGdkDisplay)
	{
		shared_ptr<FakeFloGtkDeviceManager> refInstance(
				new FakeFloGtkDeviceManager(bEnableEventClasses, aEnDisableEventClass
											, eKeyRepeatMode
...
//std::cout << "FakeFloGtkDeviceManager::create 1" << '\n';
	...
	FakeFloGtkDeviceManager(bool bEnableEventClasses, const std::vector<Event::Class>& aEnDisableEventClass
						, KEY_REPEAT_MODE eKeyRepeatMode, const shared_ptr<GdkKeyConverter>& refGdkConverter)
	: FloGtkDeviceManager(bEnableEventClasses, aEnDisableEventClass, eKeyRepeatMode, refGdkConverter)
	, m_p0Factory(nullptr)
	, m_p0Backend(nullptr)
	{
