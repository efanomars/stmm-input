...
def main():
	...
	subprocess.check_call("{} rm -r -f       {}/include/stmm-input-gtk".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm    -f        {}/lib/libstmm-input-gtk.so*".format(sSudo, sDestDir), shell=True)
	subprocess.check_call("{} rm    -f        {}/lib/libstmm-input-gtk.a".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm    -f {}/lib/pkgconfig/stmm-input-gtk.pc".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm -r -f     {}/share/doc/stmm-input-gtk".format(sSudo, sDestDir).split())
