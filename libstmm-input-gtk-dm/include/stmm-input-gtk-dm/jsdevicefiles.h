...
public:
	...
	inline const std::vector<std::string>& getFiles() const noexcept { return m_aPathName; }
	inline const std::vector<std::string>& getBaseNrFiles() const noexcept { return m_aPathBaseName; }
private:
