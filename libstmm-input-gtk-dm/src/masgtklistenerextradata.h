...
public:
	...
	inline bool isSequenceCanceled(const GdkEventSequence* p0Sequence) const noexcept
	{
		return std::find(m_aCanceledSequences.begin(), m_aCanceledSequences.end(), p0Sequence) != m_aCanceledSequences.end();
	}
	inline void setSequenceCanceled(const GdkEventSequence* p0Sequence) noexcept
	{
