...
# File:   install_libstmm-input-gtk-dm.py

# Compiles and installs the libstmm-input-gtk-dm library.
...
def main():
	...
	if not oArgs.bDontConfigure:
		subprocess.check_call("cmake {} {} {} {} {} {} {} {} ..".format(\
				sBuildSharedLib, sBuildTests, sBuildDocs, sDocsWarningsToLog, sBuildType, sOmitPlugins\
