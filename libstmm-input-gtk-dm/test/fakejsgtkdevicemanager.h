...
{
public:
	static shared_ptr<FakeJsGtkDeviceManager> create(bool bEnableEventClasses, const std::vector<Event::Class>& aEnDisableEventClasses)
	{
...
//std::cout << "FakeJsGtkDeviceManager::create 1" << '\n';
	...
	FakeJsGtkDeviceManager(bool bEnableEventClasses, const std::vector<Event::Class>& aEnDisableEventClasses)
