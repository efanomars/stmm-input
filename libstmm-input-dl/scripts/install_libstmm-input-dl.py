...
# File:   install_libstmm-input-dl.py

# Compiles and installs the libstmm-input-dl library.
...
def main():
	...
	if not oArgs.bDontConfigure:
		subprocess.check_call("cmake {} {} {} {} {} {} {} ..".format(\
				sBuildSharedLib, sBuildTests, sBuildDocs, sDocsWarningsToLog, sBuildType, sInstallDir, sSanitize).split())
