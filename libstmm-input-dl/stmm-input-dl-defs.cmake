# File: libstmm-input-dl/stmm-input-dl-defs.cmake
...
set(STMM_INPUT_DL_MINOR_VERSION 14) # !-U-!
set(STMM_INPUT_DL_VERSION "${STMM_INPUT_DL_MAJOR_VERSION}.${STMM_INPUT_DL_MINOR_VERSION}.0")

set(STMM_INPUT_DL_REQ_STMM_INPUT_BASE_VERSION "0.14") # !-U-!
...
# if (("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "") AND NOT TARGET stmm-input-dl)
#     if (BUILD_SHARED_LIBS)
#         add_library(stmm-input-dl SHARED IMPORTED)
#     else()
#         add_library(stmm-input-dl STATIC IMPORTED)
#     endif()
#     set_target_properties(stmm-input-dl PROPERTIES IMPORTED_LOCATION             "${STMMI_LIB_FILE}")
#     set_target_properties(stmm-input-dl PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${STMMINPUTDL_INCLUDE_DIRS}")
...
#     set_target_properties(stmm-input-dl PROPERTIES INTERFACE_LINK_LIBRARIES      "${STMMI_TEMP_PROPS}")
# endif()
