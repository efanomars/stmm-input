...
Tst99DeviceManager::Tst99DeviceManager(bool bEnableEventClasses, const std::vector<stmi::Event::Class>& aEnDisableEventClasses)
...
Tst99DeviceManager::~Tst99DeviceManager()
{
//std::cout << "Tst99DeviceManager::~Tst99DeviceManager()" << '\n';
}
