...
{
public:
	Tst99DeviceManager(bool bEnableEventClasses, const std::vector<stmi::Event::Class>& aEnDisableEventClasses) noexcept;

	////////////////////////////////////////////////////////////////////////////
	class Tst99Device : public Device, public Tst99Capability, public std::enable_shared_from_this<Tst99Device>
	{
	public:
		Tst99Device(const shared_ptr<DeviceManager>& refDeviceManager, const std::string& sName, int32_t nTestData) noexcept
		: Device()
		, m_sName(sName)
...
//std::cout << "Tst99DeviceManager::simulateTst99Event()  refEvent->getEventClass()=" << refEvent->getEventClass().getId() << '\n';
	...
	int32_t simulateTst99Event(int32_t nDeviceId, int32_t nButton) noexcept
	{
