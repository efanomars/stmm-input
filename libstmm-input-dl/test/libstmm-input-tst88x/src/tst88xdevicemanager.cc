...
Tst88XDeviceManager::Tst88XDeviceManager(bool bEnableEventClasses, const std::vector<stmi::Event::Class>& aEnDisableEventClasses)
...
Tst88XDeviceManager::~Tst88XDeviceManager()
{
//std::cout << "Tst88XDeviceManager::~Tst88XDeviceManager()" << '\n';
}
