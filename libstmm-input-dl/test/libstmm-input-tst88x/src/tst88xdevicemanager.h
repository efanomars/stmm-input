...
{
public:
	Tst88XDeviceManager(bool bEnableEventClasses, const std::vector<stmi::Event::Class>& aEnDisableEventClasses);
	virtual ~Tst88XDeviceManager();
	...
	public:
		 ...
		 */
		Tst88XKeyCapability(Tst88XDevice* p0Device)
		: m_p0Device(p0Device)
		{
	...
	{
	public:
		Tst88XDevice(const shared_ptr<DeviceManager>& refDeviceManager, const std::string& sName, int32_t nTestData)
		: Device()
		, m_sName(sName)
