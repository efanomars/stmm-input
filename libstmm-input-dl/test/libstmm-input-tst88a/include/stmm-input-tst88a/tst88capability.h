...
#ifndef STMI_TST_88_CAPABILITY_H
#define STMI_TST_88_CAPABILITY_H
...
protected:
	Tst88Capability() noexcept : Capability(s_oInstall.getCapabilityClass()) {}
private:
...
#endif /* STMI_TST_88_CAPABILITY_H */
