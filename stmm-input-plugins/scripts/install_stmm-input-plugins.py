...
# File:   install_stmm-input-plugins.py

# Compiles and installs the stmm-input-plugins application.
...
def main():
	...
	if not oArgs.bDontConfigure:
		subprocess.check_call("cmake {} {} {} ..".format(sBuildType, sInstallDir, sInstallMan).split())
