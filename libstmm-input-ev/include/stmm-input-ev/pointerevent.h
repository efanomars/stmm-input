...
public:
	...
	/** The type of event. */
	inline POINTER_INPUT_TYPE getType() const noexcept { return m_eType; }
	/** The button involved.
	 * @return The button or `-1` if hovering or moving the pointer.
	 */
	inline int32_t getButton() const noexcept { return m_nButton; }
	/** The pointer capability that generated the event.
	 * @return The capability or null if the capability was deleted.
	 */
	inline shared_ptr<PointerCapability> getPointerCapability() const noexcept { return m_refPointerCapability.lock(); }
	//
	shared_ptr<Capability> getCapability() const noexcept override { return m_refPointerCapability.lock(); }
...
protected:
	 ...
	 * @param refPointerCapability The capability that generated this event. Cannot be null.
	 */
	inline void setPointerCapability(const shared_ptr<PointerCapability>& refPointerCapability) noexcept
	{
...
public:
	...
	/** The direction of the scroll. */
	inline POINTER_SCROLL_DIR getScrollDir() const noexcept { return m_eScrollDir; }
	/** The pointer capability that generated the event.
	 * @return The capability or null if the capability was deleted.
	 */
	inline shared_ptr<PointerCapability> getPointerCapability() const noexcept { return m_refPointerCapability.lock(); }
