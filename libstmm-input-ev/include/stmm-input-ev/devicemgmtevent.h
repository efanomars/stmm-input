...
public:
	 ...
	 */
	inline shared_ptr<Device> getDevice() const noexcept { return m_refDevice.lock(); }
	/** Constructor.
	 ...
	 * @return The type.
	 */
	inline DEVICE_MGMT_TYPE getDeviceMgmtType() const noexcept { return m_eDeviceMgmtType; }
	 ...
	 */
	inline shared_ptr<DeviceMgmtCapability> getDeviceMgmtCapability() const noexcept { return m_refDeviceMgmtCapability.lock(); }
	//
	shared_ptr<Capability> getCapability() const noexcept override { return m_refDeviceMgmtCapability.lock(); }
...
protected:
	 ...
	 * @param refDevice The involved device. Can't be null.
	 */
	inline void setDevice(const shared_ptr<Device>& refDevice) noexcept
	{
		assert(refDevice);
	 ...
	 * @param eDeviceMgmtType The type.
	 */
	inline void setDeviceMgmtType(DEVICE_MGMT_TYPE eDeviceMgmtType) noexcept
	{
	 ...
	 * @param refDeviceMgmtCapability The device manager's capability. Can't be null.
	 */
	inline void setDeviceMgmtCapability(const shared_ptr<DeviceMgmtCapability>& refDeviceMgmtCapability) noexcept
	{
