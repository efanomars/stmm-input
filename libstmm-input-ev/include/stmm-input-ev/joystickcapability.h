...
public:
	...
	virtual bool getHasButton(JoystickCapability::BUTTON eButton) const noexcept = 0;
	...
	virtual bool getHasAxis(JoystickCapability::AXIS eAxis) const noexcept = 0;
...
protected:
	/** Constructor. */
	JoystickCapability() noexcept : Capability(s_oInstall.getCapabilityClass()) {}
	inline int32_t getMinButtonValue() const noexcept { return BUTTON_TRIGGER; } /**< The minimal value of enum JoystickCapability::BUTTON. */
	inline int32_t getMaxButtonValue() const noexcept { return BUTTON_GEAR_UP; } /**< The maximal value of enum JoystickCapability::BUTTON. */
	inline int32_t getMinAxisValue() const noexcept { return AXIS_X; } /**< The minimal value of enum JoystickCapability::AXIS. */
	inline int32_t getMaxAxisValue() const noexcept { return AXIS_TILT_Y; } /**< The maximal value of enum JoystickCapability::AXIS. */
private:
