...
bool JoystickHatEvent::getAsKey(HARDWARE_KEY& eKey, AS_KEY_INPUT_TYPE& eType, bool& bMoreThanOne) const noexcept
{
...
std::vector< std::pair<HARDWARE_KEY, Event::AS_KEY_INPUT_TYPE> > JoystickHatEvent::getAsKeys() const noexcept
{
...
bool JoystickButtonEvent::getAsKey(HARDWARE_KEY& eKey, AS_KEY_INPUT_TYPE& eType, bool& bMoreThanOne) const noexcept
{
