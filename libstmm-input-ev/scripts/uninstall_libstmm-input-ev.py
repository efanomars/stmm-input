...
def main():
	...
	subprocess.check_call("{} rm -r -f       {}/include/stmm-input-ev".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm    -f        {}/lib/libstmm-input-ev.so*".format(sSudo, sDestDir), shell=True)
	subprocess.check_call("{} rm    -f        {}/lib/libstmm-input-ev.a".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm    -f {}/lib/pkgconfig/stmm-input-ev.pc".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm -r -f     {}/share/doc/stmm-input-ev".format(sSudo, sDestDir).split())
