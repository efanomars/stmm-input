...
def main():
	...
	subprocess.check_call("{} rm -r -f       {}/include/stmm-input".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm    -f        {}/lib/libstmm-input.so*".format(sSudo, sDestDir), shell=True)
	subprocess.check_call("{} rm    -f        {}/lib/libstmm-input.a".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm    -f {}/lib/pkgconfig/stmm-input.pc".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm -r -f     {}/share/doc/stmm-input".format(sSudo, sDestDir).split())
