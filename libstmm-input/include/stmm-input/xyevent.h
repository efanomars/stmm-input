...
public:
	 ...
	 * @return X coordinate.
	 */
	inline double getX() const noexcept { return m_fX; }
	/** The main Y coordinate.
	 * @return Y coordinate.
	 */
	inline double getY() const noexcept { return m_fY; }
	 ...
	 */
	inline bool getIsModified() const noexcept { return m_bIsModified; }
	 ...
	 */
	inline XY_GRAB_INPUT_TYPE getXYGrabType() const noexcept { return m_eXYGrabType; }
	/** Identifies what is grabbed.
	 * Ex. For a touch device it could be a finger.
	 * @return The id or undefined if `getXYGrabType() == XY_HOVER`.
	 */
	inline int64_t getXYGrabId() const noexcept { return m_nGrabId; }
...
protected:
	...
	XYEvent(const Class& oClass, int64_t nTimeUsec, int32_t nCapabilityId
			...
			, XY_GRAB_INPUT_TYPE eXYGrabType, int64_t nGrabId) noexcept;
	/** Sets X.
	 * The modified flag is not changed by this function.
	 * @param fX The new value.
	 */
	inline void setX(double fX) noexcept { m_fX = fX; }
	/** Sets Y.
	 * The modified flag is not changed by this function.
	 * @param fY The new value.
	 */
	inline void setY(double fY) noexcept { m_fY = fY; }
	 ...
	 */
	inline void setIsModified(bool bIsModified) noexcept { m_bIsModified = bIsModified; }
	/** Sets the grab type and id.
	 * The modified flag is not changed by this function.
	 * @param eXYGrabType The new grab type.
	 * @param nGrabId The new id.
	 */
	inline void setXYGrab(XY_GRAB_INPUT_TYPE eXYGrabType, int64_t nGrabId) noexcept
	{
