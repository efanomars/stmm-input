...
def main():
	...
	createSymlink("libstmm-input", sSrcDir)
	createSymlink("libstmm-input-base", sSrcDir)
	createSymlink("libstmm-input-dl", sSrcDir)
	createSymlink("libstmm-input-ev", sSrcDir)
	createSymlink("libstmm-input-fake", sSrcDir)
	createSymlink("libstmm-input-gtk", sSrcDir)
	createSymlink("libstmm-input-gtk-dm", sSrcDir)
