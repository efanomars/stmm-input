...
def main():
	...
	if not oArgs.bOmitPlugins:
		...
		print("== install stmm-input-plugins =========" + sInfo + "==")
		os.chdir("stmm-input-plugins/scripts")
		subprocess.check_call("./install_stmm-input-plugins.py {} {} {} {} {} {} {}".format(sBuildType, sInstallDir\
	...
	if not oArgs.bOmitGtk:
		...
		subprocess.check_call("./install_libstmm-input-gtk-dm.py {} {} {} {} {} {} {} {} {} {} {} {}".format(\
				sBuildStaticLib, sBuildTests, sBuildDocs, sDocsWarningsToLog, sBuildType, sInstallDir\
				, sNoConfigure, sNoMake, sNoInstall, sSudo, sSanitize, sOmitPlugins).split())
		os.chdir("../..")
