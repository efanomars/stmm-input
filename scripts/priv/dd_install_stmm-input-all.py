...
# File:   dd_install_stmm-input-all.py
...
# In addition to the pk_install_stmm-input-all.py parameters it sets the DESTDIR 
...
def main():
	...
	oParser = argparse.ArgumentParser(description="Install all stmm-input projects.\n"
						"  Same as pk_install_stmm-input-all.py but sets DESTDIR environment variable.\n"
	...
	oParser.add_argument("--omit-plugins", help="do not build plugins related project", action="store_true"\
	...
	subprocess.check_call("./pk_install_stmm-input-all.py {} {} {} {} {} {} {} {} {} {} {} {} {} {}".format(\
			sBuildStaticLib, sBuildTests, sOmitGtk, sOmitPlugins, sBuildDocs, sDocsWarningsToLog, sBuildType, sInstallDir\
