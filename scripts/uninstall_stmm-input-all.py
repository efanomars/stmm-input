...
def main():
	...
	subprocess.check_call("./libstmm-input-dl/scripts/uninstall_libstmm-input-dl.py -y {} --destdir {}  {}"\
						.format(sRemoveBuilds, sDestDir, sSudo).split())
	...
	subprocess.check_call("./libstmm-input-gtk-dm/scripts/uninstall_libstmm-input-gtk-dm.py -y {} --destdir {}  {}"\
						.format(sRemoveBuilds, sDestDir, sSudo).split())
