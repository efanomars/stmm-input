...
def main():
	...
	subprocess.check_call("./libstmm-input-gtk-dm/scripts/uninstall_libstmm-input-gtk-dm.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-input-gtk/scripts/uninstall_libstmm-input-gtk.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-input-fake/scripts/uninstall_libstmm-input-fake.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-input-ev/scripts/uninstall_libstmm-input-ev.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-input-dl/scripts/uninstall_libstmm-input-dl.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-input-base/scripts/uninstall_libstmm-input-base.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-input/scripts/uninstall_libstmm-input.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./stmm-input-plugins/scripts/uninstall_stmm-input-plugins.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())
