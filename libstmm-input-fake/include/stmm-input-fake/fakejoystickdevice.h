...
public:
	 ...
	 */
	FakeJoystickCapability(FakeDevice<FakeJoystickCapability>* p0Device)
	: m_p0Device(p0Device)
	{
...
public:
	 ...
	 */
	FakeJoystickDevice(const shared_ptr<DeviceManager>& refDeviceManager, const std::string& sName)
