...
def main():
	...
	subprocess.check_call("{} rm -r -f       {}/include/stmm-input-base".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm    -f        {}/lib/libstmm-input-base.so*".format(sSudo, sDestDir), shell=True)
	subprocess.check_call("{} rm    -f        {}/lib/libstmm-input-base.a".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm    -f {}/lib/pkgconfig/stmm-input-base.pc".format(sSudo, sDestDir).split())
	subprocess.check_call("{} rm -r -f     {}/share/doc/stmm-input-base".format(sSudo, sDestDir).split())
